    ...
    <>
      ...
      <div>
        <form onSubmit={handleSubmit} className="form-userprofile">
          ...
          <label htmlFor="email" className="label-userprofile">
            E-mail address:
          </label>
          <input
            type="email"
            id="email"
            name="email"
            className="input-userprofile"
            value={formData.email}
            onChange={handleChange}
          />
          <br />

          <label htmlFor="fname" className="label-userprofile">
            First Name:
          </label>
          <input
            type="text"
          ...
          <label htmlFor="lname" className="label-userprofile">
            Last Name:
          </label>
          <input
            type="text"
          ...
          <label htmlFor="phone" className="label-userprofile">
            Phone Number:
          </label>
          <input
            type="tel"
          ...
          <label htmlFor="address" className="label-userprofile">
            Address:
          </label>
          <textarea
            id="address"
            name="adresse"
            className="tex-userprofile"
